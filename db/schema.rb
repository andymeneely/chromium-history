...
ActiveRecord::Schema.define(version: 20140512131450) do
  ...
  create_table "release_filepaths", id: false, force: true do |t|
    ...
    t.integer "num_regression_word_used"
    t.integer "num_compat_word_used"
    t.integer "num_security_word_used"
    t.integer "num_stabil_crash_word_used"
    t.integer "num_stabil_mem_address_word_used"
    t.integer "num_future_regression_bugs"
    t.integer "num_future_compat_bugs"
    t.integer "num_future_security_bugs"
    t.integer "num_future_stabil_crash_bugs"
    t.integer "num_future_stabil_mem_address_bugs"
    t.boolean "was_buggy"
