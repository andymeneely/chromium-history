...
function calendarScraper(){
  ...
  for(calIndex=0;calIndex<calendarNames.length;calIndex++){
    ...
    var events = cal.getEvents(new Date("January 1, 2008"), new Date("August 31, 2017"));
    ...
    for (var i=1;i<events.length;i++) {
      ...
      var details=[[calendarNames[calIndex], events[i].getStartTime(), events[i].getEndTime(), guestEmails,guestEmails.length]];
