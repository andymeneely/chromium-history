...
class CveLoader
	...
	def load_cve
		fileName = "#{Rails.configuration.datadir}/CVEs/chromium_clean_cves.csv"
		CSV.foreach("../results/chromium_cves_clean.csv", :headers => false) do | row |
			cveModel = transfer(Cve.new, row[0], @@CVES_PROPS)
